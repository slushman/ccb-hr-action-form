import FillPositionFields from '../FillPositionFields';
import { shallowFactory } from '../../../testUtils';

const factory = shallowFactory(FillPositionFields, {});

describe('<FillPositionFields/>', () => {
  it('renders without crashing', () => {
    ...
    expect(placeholderContent).toBe('Fill Position');
